...
class add_edit extends Authormodel
{
	...
	public function addauthordetails($authorid, $userid)
	{
		...
		$facebook = addslashes($this->input->post('txtfacebook'));
		$twitter = addslashes($this->input->post('txttwitter'));
		$instagram = addslashes($this->input->post('txtinstagram'));
		...
		if($get_auhorid == "")
		{
			...
			$this->db->query("UPDATE authormaster SET mobile='".$phone."',facebook='".$facebook."',twitter='".$twitter."',instagram='".$instagram."' WHERE Author_id='".$last_insert_id."'");
		...
		else if($get_auhorid != "")
		{
			...
			$this->db->query("UPDATE authormaster SET mobile='".$phone."',facebook='".$facebook."',twitter='".$twitter."',instagram='".$instagram."' WHERE Author_id='".$get_auhorid."'");
