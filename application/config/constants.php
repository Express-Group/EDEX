...
//define('source_base_path', '/var/www/html/edex_demo/');
//define('destination_base_path', '/var/www/html/edex_demo/');
define('source_base_path', '/images/edex_images/');
define('destination_base_path', '/images/edex_images/');
...
define('image_url', 'https://images.edexlive.com/');
define('image_url_no', 'http://images.edexlive.com/');
define('no_articles', 'Please add articles to show');	
define('BASEURL', 'https://www.edexlive.com/');
define('HOMEURL', 'https://www.edexlive.com/'); 
define('AMPURL', 'www.edexlive.com/');
define('MOBILEURL', 'https://m.edexlive.com/');
define('VERSION', '1.6');
