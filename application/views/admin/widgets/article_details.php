  ...
  <?php if($is_author==1 && $is_agency==1){ ?>
   ...
   <?php
	 ...
	 <div class="Social_Font"> <div class="PrintSocial articles_social_icons"> 
		<!--<div class="social_icon_count"><span class="article_fb_count"><span id="article_fb_count">0</span><span class="fb_ext"></span></span><br><span class="article_fb_shares">shares</span></div>-->
		<a href="javascript:;" class="csbuttons" data-type="facebook" data-count="true"><img src="<?php echo image_url ?>images/static_img/fb.png" data-src="<?php echo image_url ?>images/static_img/fb.png" class="img-responsive" alt="f_icon" width="48" height="48"></a>
		<a class="csbuttons" data-type="twitter" data-txt="<?php echo strip_tags($content_title);?>" data-via="xpress_edex" data-count="true"><img src="<?php echo image_url ?>images/static_img/twitter.png" data-src="<?php echo image_url ?>images/static_img/twitter.png" class="img-responsive" width="48" height="48" alt="t_icon"></a>
		
		<a href="https://www.instagram.com/edexliveinsta/" target="_blank"><img src="<?php echo image_url ?>images/static_img/instagram.png" data-src="<?php echo image_url ?>images/static_img/instagram.png" class="img-responsive" width="48" height="48" alt="i_icon"></a>
		
		
		<a href="https://www.linkedin.com/shareArticle?url=<?php echo $article_url;?>&mini=true" target="_blank"><img src="<?php echo image_url ?>images/static_img/linkedin.png" data-src="<?php echo image_url ?>images/static_img/linkedin.png" class="img-responsive" width="48" height="48" alt="l_icon"></a>
		<a onclick="window.open('https://kooapp.com/create?title=<?php echo strip_tags($content_title);?>&link=<?php echo $article_url; ?>&language=en','winopen','width=800,height=500');"><img src="<?php echo image_url ?>images/static_img/koo1.png" data-src="<?php echo image_url ?>images/static_img/koo1.png" class="img-responsive" width="48" height="48" alt="koo_icon"></a>
		<a class="whatsapp" href="" data-txt="<?php echo strip_tags($content_title);?>" data-link="<?php echo $article_url;?>"><img src="<?php echo image_url ?>images/static_img/whatsapp.png" data-src="<?php echo image_url ?>images/static_img/whatsapp.png" class="img-responsive" width="48" height="48" alt="whatsapp_icon"></a>
		<a class="Share_Icons PositionRelative"><img  id="popoverId" src="<?php echo image_url ?>images/static_img/email.png" data-src="<?php echo image_url ?>images/static_img/email.png" class="img-responsive" width="48" height="48" alt="email_icon"></a>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail ArticleDetailContent <?php echo $special_class;?>">
  <div id="content" class="content" itemprop="description">
    ...
    <figure class="AticleImg open_image">
      ...
      <img src="<?php echo $dummy_image;?>" data-src="<?php echo $show_image;?>" title="<?php echo $image_caption;?>" alt="<?php echo $image_alt;?>" itemprop="image">
      <?php if($image_caption!=''){ ?>
      <p class="AticleImgBottom"><?php echo strip_tags($image_caption);?></p>
      <?php } ?>
    </figure>
    <?php } ?>
     <div id="storyContent" class="<?php if($this->uri->segment(1)=='adcheck'): echo 'hide-story'; endif; ?>">
	<?php
		if(isset($_SERVER['HTTP_CLOUDFRONT_IS_MOBILE_VIEWER']) && @$_SERVER['HTTP_CLOUDFRONT_IS_MOBILE_VIEWER']=="true"){
			...
			foreach ($ptag as $p){
				...
				if($i==3){
					...
					$advContent = "<span style=\"margin:0;font-size: 7px !important;margin-bottom: 8px !important;text-align: right !important;\" class=\"scc-span\">ADVERTISEMENT</span><div class=\"scc-div\"><!-- GPT AdSlot 2 for Ad unit 'Edex_Mobile_AP_MID_300x250' ### Size: [[300,250]] --><div id='div-gpt-ad-6406044-2'><script>googletag.cmd.push(function() { googletag.display('div-gpt-ad-6406044-2'); });</script></div><!-- End AdSlot 2 --></div>";
	  ...
	  ?>
	  <a title="telegram" target="_BLANK" href="https://t.me/edexlive"><img src="https://images.edexlive.com/images/FrontEnd/images/telegram_strap.webp" data-src="https://images.edexlive.com/images/FrontEnd/images/telegram_strap.webp" alt="telegram" style="width:100%;max-width:100% !important;"></a>
    </div>
	<style>
...
<script src="<?php echo image_url; ?>js/FrontEnd/js/remodal-article.js?version=<?php echo VERSION; ?>"></script>
			...
			ajaxRequest.done(function(result){
				...
				if(result.status ==1){
					...
					if(result.tags!=''){
						...
						var i,m;
						m=1;
						hasTags += '<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ArticleDetail"><div class="tags">';
					...
					socialIcons +='<a href="https://www.instagram.com/edexliveinsta/" target="_blank" class="csbuttons insta" data-type="instagram" data-txt="Instagram" data-url="" data-via="xpress_edex" data-count="true"><img src="<?php echo image_url ?>images/static_img/instagram.png" class="img-responsive"></a>';
					...
					articleTemplate += '<div class="row" style="overflow: unset;"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail ArticleDetailContent></div><div id="content_'+contentBlock+'" class="content">'+hasImage+'<div id="storyContent">'+result.content+'</div>';
