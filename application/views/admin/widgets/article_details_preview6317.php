...
<div class="row">
 ...
 <?php  if($author_image!=''){?> 
   <div class="strapimg"><img class="img-circle" alt="" src="http://images.newindianexpress.com/<?php echo $author_image;?>"></div>
   <?php if($is_author==1 && $is_agency==1){ ?>
   <div class="author_name"><span><a href="<?php echo base_url().$author_url;?>" target="_blank"><?php echo $author_name;?></a></span></span> <br>
        <div class="author_pro"><span>Columnist, Edex</span></div></div>
      ...
      <div class="author_name"><span><?php echo $agency_name;?></span> <br>
        <div class="author_pro"><span>Edex</span></div></div>
      <?php } ?>
   <?php }
   else
   { ?>
   <div class="strapimg"><img class="img-circle" alt="" src="http://edex.newindianexpress.com/images/static_img/no_author.jpg"></div>
  <?php if($is_author==1 && $is_agency==1){ ?>
      <div class="author_name"><span><a href="<?php echo base_url().$author_url;?>" target="_blank"><?php echo $author_name;?></a></span></span> <br>
        <div class="author_pro"><span>Columnist, Edex</span></div></div>
      <?php }else if($author_name!=''){ ?>
