...
if(count($widget_contents) > 0)
{
	...
	foreach($widget_contents as $key_value => $get_content)
	{
		...
		if(($i%2)==0):
			...
			$show_simple_tab .='<a href="'.$live_article_url.'"><p class="para_center">'.stripslashes($summary).'</p></a>';
			...
			$show_simple_tab .='<div class="vid_im"><a href="'.$live_article_url.'"><img src="'.$dummy_image.'" data-src="'.$show_image.'" alt="'.$imagealt.'"  title = "'.$imagetitle.'" class="grayscale"></a></div></div>';  
		else:
			//added for second slot
			$show_simple_tab .='<div class="row">';
			$show_simple_tab .='<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 health-bottom">';
			$show_simple_tab .='<div class="vid_im"><a href="'.$live_article_url.'"><img src="'.$dummy_image.'" data-src="'.$show_image.'" alt="'.$imagealt.'"  title = "'.$imagetitle.'" class="grayscale"></a></div>';
			$show_simple_tab .='</div>';
