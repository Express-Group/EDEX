...
<input type="text" placeholder="Search..." name="search_term" id="mobile_srch_term" value="<?php echo $search_term;?>"/> <a href="javascript:void(0);" id="mobile_search"><img src="<?php echo image_url; ?>images/FrontEnd/images/search-mob.png" data-src="<?php echo image_url; ?>images/FrontEnd/images/search-mob.png" /></a></form></div>
...
<div class="social_icons SocialCenter mobile-share"> <a class="fb" href="https://www.facebook.com/edexnie/" rel="noopener" target="_blank"><i class="fa fa-facebook"></i></a> <a class="twit" href="https://twitter.com/xpress_edex" rel="noopener" target="_blank"><i class="fa fa-twitter"></i></a><a class="instagram" href="https://www.instagram.com/edexliveinsta/" rel="noopener" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a><a class="pinterest" href="https://www.linkedin.com/in/edexlive/" rel="noopener" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a><a class="youtube" href="https://www.youtube.com/channel/UCycKg_4JJxw_SMhdyXVnWgA" rel="noopener" target="_blank"><i class="fa fa-youtube-play" aria-hidden="true"></i></a><!--
           <a class="rss" href="<?php echo $header_details['rss_url'];?>" target="_blank"><i class="fa fa-rss"></i></a><a class="google" href="<?php echo $header_details['google_plus_url'];?>" target="_blank"><i class="fa fa-google-plus"></i></a>--> </div>
            <ul class="MobileNav">
          ...
          <li><a href="https://twitter.com/xpress_edex" rel="nofollow" target="_blank"><i class="fa fa-twitter"></i></a></li>
...
<img src="'.image_url.$header_details['sitelogo'].'" data-src="'.image_url.$header_details['sitelogo'].'" alt="site_logo"></a>';
?>
