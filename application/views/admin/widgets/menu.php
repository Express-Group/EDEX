<style>.edexworksimg{position: absolute;width: 40px;top: -14px;left: 0;z-index: 9;}@media only screen and (max-width: 768px){.edexworksimg{top: -12px;}}</style>
<?php 
...
<div class="row">
  <div class="col-lg-12">
    ...
    <?php if(strtolower($Section_Details['Sectionname']))
				 { ?>
        ...
        <ul class="nav navbar-nav menus">
          ...
          <?php
				 ...
				 else
				 {
					 ...
					 {
				 ?>
          <li class="index_hide active"><a title="go to home" data-toggle="tooltip" data-placement="top" href="<?php echo base_url(); ?>"><i class="fa fa-home"></i></a></li>
          <?php 
                     }
                     else
                     { ?>
          <li class="index_hide "><a title="go to home" data-toggle="tooltip" data-placement="top" href="<?php echo base_url(); ?>"><i class="fa fa-home"></i></a></li>
          <?php }
					 }
				if ($Section_Count == 13 ) 
				break;   
