...
<html amp>
	<head>
		...
		<title><?php print strip_tags($content['meta_Title']); ?> - Edexlive</title>
		...
		<style amp-custom>
			 ...
			 body {font-family: "Oswald", serif;line-height: 1.5; }
			...
			.article_heading{margin-top:5px;margin-bottom: 8px; color: #000;font-size: 23px;line-height: 1.3;}
	...
	<body>
		<div class="header">
			<a href="<?php print BASEURL; ?>"><amp-img alt="Edex logo"
		...
		<article class="article">
			...
			<div class="socialicons">
				...
				<amp-social-share type="facebook" data-param-app_id="272592156694146" width="38" height="33" class="social-icons"></amp-social-share>
