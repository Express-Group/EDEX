  ...
  <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="bcrums"> 
	...
	<?php } }
	 ...
	 <?php if($content_type == 1) { ?>
      <p class="ArticlePublish"><?php if($author_name != '') { ?> <?php } ?></span><?php if($publishdate != '') { ?> Published:<span> <?php echo $publishdate; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?> </p>
	 ...
	 <?php } else { ?>
      ...
      <p class="ArticlePublish"><?php if($author_name != '') { ?> <?php } ?></span><?php if($publishdate != '') { ?> Published:<span> <?php echo $publishdate; ?></span>&nbsp;&nbsp;|&nbsp;&nbsp;<?php } ?> <?php if($last_update != '') { ?>Last Updated:<span> <?php echo $last_update; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?></p>
	  
	 <?php } ?>
      <p></p>
      	<div class="strapimg"><img class="img-circle" alt="" src="http://images.edexlive.com/images/static_img/no_author.jpg"></div>
             <div class="strapauthor"><a href="<?php echo base_url().$author_url;?>" target="_blank"><span><?php echo ucfirst($author_name); ?></span>
</a>&nbsp;&nbsp;|&nbsp;&nbsp;<span><?php echo $agency_name;?></span>&nbsp;&nbsp;|&nbsp;&nbsp;<span>Edex</span></div>
