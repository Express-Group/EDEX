...
<form method="post" name="redirect" id="redirect" onsubmit="validateform(event);" action="https://test.ccavenue.com/transaction/transaction.do?command=initiateTransaction"> 
<?php
