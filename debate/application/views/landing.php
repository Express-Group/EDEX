...
setTimeout("ga('send','event','adjusted bounce rate','page visit 30 seconds or more')",30000);
				...
				<div class="col-xl-3 col-md-3 col-sm-3 col-xs-3 col-3 pt-5 pl-8">
					<div class="dropdown mobile-dropdown">
						...
						<div class="dropdown-menu" style="">
							<a class="dropdown-item menu-index" href=""><i class="fa fa-caret-right"></i> Home</a>
							...
							<a class="dropdown-item  menu-schedule" href=""><i class="fa fa-caret-right"></i> Schedule</a>
			...
			<div class="row d-none d-lg-block d-xl-block d-md-block">
				<div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 col-12 text-center">
					<div class="menus">
						...
						<!--<a class="menu-schedule" href="">Schedule</a>-->
						...
						<a href="<?php echo base_url('result/final');?>">Final Result</a>
						<a class="menu-contact" href="">Contact Us</a>
	...
	<section class="video mt-3">
		<div class="container">
			<div class="row">
				<div class="col-xl-6 col-md-6 col-sm-6 col-xs-6 col-12 text-center">
					<div class="video-wrapper vd1">
						<iframe style="width:100%;" width="560" height="280" src="https://www.youtube.com/embed/GbmYVoGW4vQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
				</div>
				<div class="col-xl-6 col-md-6 col-sm-6 col-xs-6 col-12 text-center">
					<div class="video-wrapper">
						<iframe style="width:100%;" width="560" height="280" src="https://www.youtube.com/embed/8APf_teuP2g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
				</div>
			</div>
		</div> 
	...
	<section class="about">
		<div class="container">
			<div class="row">
				<div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 col-12 text-center mt-5">
	...
	<section class="register">
		<div class="container">
			<div class="row">
				<!--<div class="col-xl-8 col-md-8 col-sm-8 col-xs-8 col-12 offset-xl-2 offset-lg-2 offset-md-2 offset-sm-2 mt-5">
					...
					<!--<div class="form-group">
						...
						<select class="form-control" id="school" name="school">
							...
							foreach($schoolList as $school){
								echo '<option value="'.$school->sid.'">'.$school->name.'</option>';
							}
							?>
						</select>
					...
					<div class="form-group">
						...
						<input class="form-control" id="user_image" name="user_image" type="file" accept="image/*">
					</div>
					<div class="form-group">
						<label>Upload School ID</label>
						<input class="form-control" id="id_image" name="id_image" type="file" accept="image/*">
					</div>-->
					<!--<div class="form-group">
			...
			<p class="text-center contact-title">If you're not able to register above, you can also fill in your details </p>
			<p class="text-center contact-title"> in this <a style="color: blue" target="_BLANK" href="https://docs.google.com/forms/d/e/1FAIpQLSdy3XE90rt1yt1R3wzrPm1cVpkQcBRikGvA0Uwdgzwhyy1_bw/viewform">Google Form </a> and our team will get back to you  </p>
		</div>-->
		<h1 class="text-center title mt-5" style="width:100%;">Dear students,</h1>
		 
		<p class="text-center contact-title">Let's Debate registrations are now closed. Thank you for your interest. 
If you tried registering earlier but were unable to, please reach out to +91 89398 01211. </p>
	...
	<section class="contact-us mb-5">
		<div class="container">
			<div class="row">
				...
				<div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 col-12 mt-5 text-center sch">
					<h1 class="text-center title">Schedule</h1>
					
					<!--<p class="text-center contact-title"> <b>Registration till March 10 </b> </p>
					<p class="text-center contact-title">  Recording for Junior batch on March 29, 30, 31 & April 1  </p> 
					<p class="text-center contact-title"> Recording for Senior batch on April 7, 8, 9, 10 </p>-->				

				</div>
				<div class="col-xl-8 col-md-8 col-sm-8 col-xs-8 col-12 offset-xl-2 offset-lg-2 offset-md-2 offset-sm-2">
					<h4 style="font-weight: 700;color: #264e82;">India's youth are disconnected from our history, politics and culture because it isn't made attractive enough</h4>
					<p class="text-left">Streaming at: <b>April 19 | 6 pm</b></p>
					<p class="text-left">Watch it at: <b><a style="color:red;" href="https://bit.ly/2Q5ZyV4" target="_BLANK">https://bit.ly/2Q5ZyV4</a></b></p>
					<hr style="border-top: 2px solid #264e82;">
					<h4 style="font-weight: 700;color: #264e82;">Learning in one's mother tongue instead of English-medium till grade 5 will preserve our languages, culture</h4>
					<p class="text-left">Streaming at: <b>April 19 | 7.15 pm</b></p>
					<p class="text-left">Watch it at: <b><a style="color:red;" href="https://bit.ly/3uQS07i" target="_BLANK">https://bit.ly/3uQS07i</a></b></p>
					<hr style="border-top: 2px solid #264e82;">
					<h4 style="font-weight: 700;color: #264e82;">India's education system does not foster innovation and is outdated</h4>
					<p class="text-left">Streaming at: <b>April 20 | 6 pm</b></p>
					<p class="text-left">Watch it at: <b><a style="color:red;" href="https://bit.ly/3snO6RR" target="_BLANK">https://bit.ly/3snO6RR</a></b></p>
					<hr style="border-top: 2px solid #264e82;">
					<h4 style="font-weight: 700;color: #264e82;">It is right for schools and governments to monitor your social media activity</h4>
					<p class="text-left">Streaming at: <b>April 20 | 7.15 pm</b></p>
					<p class="text-left">Watch it at: <b><a style="color:red;" href="https://bit.ly/3di24QN" target="_BLANK">https://bit.ly/3di24QN</a></b></p>
					<hr style="border-top: 2px solid #264e82;">
					<h4 style="font-weight: 700;color: #264e82;">Students should have the right to protest for just causes when in school</h4>
					<p class="text-left">Streaming at: <b>April 21 | 6 pm</b></p>
					<p class="text-left">Watch it at: <b><a style="color:red;" href="https://bit.ly/3gcCmiq" target="_BLANK">https://bit.ly/3gcCmiq</a></b></p>
					<hr style="border-top: 2px solid #264e82;">
					<h4 style="font-weight: 700;color: #264e82;">Ancient Indian Science achieved more than modern Indian research</h4>
					<p class="text-left">Streaming at: <b>April 21 | 7.15 pm</b></p>
					<p class="text-left">Watch it at: <b><a style="color:red;" href="https://bit.ly/2QtZe2l" target="_BLANK">https://bit.ly/2QtZe2l</a></b></p>
					<hr style="border-top: 2px solid #264e82;">
					<h4 style="font-weight: 700;color: #264e82;">Festivals like Diwali being labeled as pollution fests: Fact or hypocrisy?</h4>
					<p class="text-left">Streaming at: <b>April 22 | 6 pm</b></p>
					<p class="text-left">Watch it at: <b><a style="color:red;" href="https://bit.ly/3uS4FH9" target="_BLANK">https://bit.ly/3uS4FH9</a></b></p>
					<hr style="border-top: 2px solid #264e82;">
					<h4 style="font-weight: 700;color: #264e82;">Tuition/NEET/JEE coaching classes should be restricted only to the weekends</h4>
					<p class="text-left">Streaming at: <b>April 22 | 7.15 pm</b></p>
					<p class="text-left">Watch it at: <b><a style="color:red;" href="https://bit.ly/2QqryTg" target="_BLANK">https://bit.ly/2QqryTg</a></b></p>
					<hr style="border-top: 2px solid #264e82;">
					<h4 style="font-weight: 700;color: #264e82;">Using Made In India products shows your patriotism</h4>
					<p class="text-left">Streaming at: <b>April 22 | 8.15 pm</b></p>
					<p class="text-left">Watch it at: <b><a style="color:red;" href="https://bit.ly/3e4fCyt" target="_BLANK">https://bit.ly/3e4fCyt</a></b></p>
					<hr style="border-top: 2px solid #264e82;">
				</div>
				<div class="col-xl-8 col-md-8 col-sm-8 col-xs-8 col-12 offset-xl-2 offset-lg-2 offset-md-2 offset-sm-2 mt-5 con">
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-body text-center">
					...
					<h2 style="color:green;" class="text-center">We will contact you soon.</h2>
	...
	<script type="text/javascript">
	  ...
	  $(document).ready(function(e){
		  ...
		  $('.menu-contact').on('click' , function(e){
			e.preventDefault(); 
			$('html,body').animate({scrollTop: $(".con").offset().top},'slow');
		  });
		  $('.menu-schedule').on('click' , function(e){
			e.preventDefault(); 
			$('html,body').animate({scrollTop: $(".sch").offset().top},'slow');
		  });
